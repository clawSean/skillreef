...
*Logged 2026-06-24 after a live incident on the operator's Telegram DM. Status: root cause
...
1. The operator's DM (`agent:example:telegram:direct:1234567890`) was pinned to
