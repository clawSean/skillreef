...
(scripts/browserless_extract.py) for single reads. Reach for a persistent
...
Examples:
  ...
  python3 scripts/browserless_session.py inspect --session-file /tmp/bl-session.json

  # Stop the session and delete the local file:
  python3 scripts/browserless_session.py stop --session-file /tmp/bl-session.json --delete-file
"""
